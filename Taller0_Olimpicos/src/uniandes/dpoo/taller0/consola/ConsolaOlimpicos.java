...
public class ConsolaOlimpicos
{
	...
	*/
	...
	private void ejecutarPaisAtleta() {
		System.out.println("\n"+"Consultar el pais de un atleta dado su nombre");
		String nombre = input("Nombre del atleta que desea buscar: ");
		Pais pais = calculadora.paisAtleta(nombre);
		String nombrePais = pais.darNombre();
		System.out.println("El pais del atlteta es: " + nombrePais);
